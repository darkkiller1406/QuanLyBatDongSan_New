    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                ...
                <!-- Single Slide -->
                <img src="<?php echo $chitiet->Hinh ?>" class="img-responsive" alt="properties" width="100%"/>
                    ...
                    <?php if($chitiet->TrangThai ==0 ) { ?>
                        <div class="realtor-info">
                            ...
                            <div class="realtor--contact-form">
                                <form action="{{route('ThemYeuCau_Web')}}" method="post">
                                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                    <input type="hidden" name="iddat" value="<?php echo $chitiet->link ?>">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="realtor-name" name="ten"
                                        placeholder="Tên đầy đủ" required>
                                    </div>
                                    <div class="form-group">
                                        <input type="email" class="form-control" id="realtor-number" name="email"
                                        placeholder="Email" required>
                                    </div>
                                    <div class="form-group">
                                        <input type="number" class="form-control" id="realtor-email" name="dt" id="dt"
                                        placeholder="Điện thoại liên lạc" required>
                                    </div>
                                    <div class="form-group">
                                        <textarea name="message" class="form-control" id="realtor-message" cols="30"
                                        rows="10" name="yeucau" placeholder="Yêu cầu"></textarea>
                                    </div>
