...
@section('content')
 ...
 Sửa tin /////////-->
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <input type="text" name="tieude" class="lease-input form-control"
                                       value="{{$kq->TieuDe}}" id="tieude" required>
                            ...
                            <div class="col-lg-12">
                                ...
                                <input type="text" id="diachi" class="lease-input form-control"
                                       value="{{$kq->DiaChi}}"/>
                        ...
                        <div class="col-md-12">
                            <p><i class="fas fa-bell"></i> Nếu địa chỉ hiển thị bên bản đồ không đúng bạn có thể điều
                                chỉnh bằng cách kéo điểm màu xanh trên bản đồ tới vị trí chính xác.</p>
                            <div id="map-canvas"
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="number" min="0" class="form-control lease-select" value="{{$kq->DienTich}}"
                                   name="dientich" id="dientich">
                            <div id="ktdt" class="sub"></div>
                        </div>
                        <div class="col-lg-6">
                            <label class="col-lg-4 lease-label">Giá tiền</label>
                            <input type="number" min="0" class="lease-select form-control" value="{{$kq->Gia}}"
                                   name="gia" id="gia">
                            <div id="ktgia" class="sub"></div>
                        </div>
                        <div class="col-lg-12">
                            <label class="col-lg-2 lease-label margin-lable">Hình ảnh</label>
                            <input type="file" id='file' class="lease-input form-control" name="image[]"
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="contact-form">
                                <div class="form-group">
                                    <textarea class="lease-input form-control" name="mota" id="mota" cols="30"
                                              rows="10">{{$kq->MoTa}}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <input type="text" class="lease-input form-control" value="{{$kq->TenLienHe}}" name="lienhe"
                               id="tenlienhe">
                        <div class="class=" col-lg-2
                        ">
                    </div>
                ...
                <div class="col-lg-12">
                    ...
                    <input type="text" class="lease-input form-control" value="{{$kq->DiaChiLienLac}}" name="diachill"
                           id="diachill">
                    <div class="class=" col-lg-2
                    ">
                </div>
            ...
            <div class="col-lg-12">
                ...
                <input type="text" class="lease-input form-control" value="{{$kq->DienThoaiLienLac}}" name="dtdd"
                       id="dienthoai">
                <div class="class=" col-lg-2
                ">
            </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            <input type="hidden" class=" form-control" name="ngayketthuc" id="ngayketthuc"
                   value="<?php echo date('Y-m-d', strtotime($kq->NgayKetThuc)) ?>">
            <input type="hidden" class=" form-control" name="ngaybatdau" id="ngaybatdau"
                   value="<?php echo date('Y-m-d', strtotime($kq->NgayBatDau)) ?>">
        </div>
        <div class="col-lg-4">
            <label class="lease-label">Ngày kết thúc</label>
            <input type="date" class=" form-control" name="ngayketthuc" id="ngayketthuc" disabled="disabled"
                   value="<?php echo date('Y-m-d', strtotime($kq->NgayKetThuc)) ?>">
    ...
    <div class="row">
        ...
        <button class="btn south-btn" name="Submit" onClick="SuaTin()"
                style="width: 20%;font-size: 15px;margin-top:50px">Cập nhật
        </button>
    </div>
    </div>
    </div>
    ...
    <section class="south-contact-area section-padding-100">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12">
                    <label class="col-lg-2 lease-label margin-lable">Tiêu đề</label>
                    <input type="text" name="tieude" class="lease-input form-control" placeholder="Tên đầy đủ"
                           id="tieude" required>
                    <div class="class=" col-lg-2
                    ">
                </div>
        ...
        <div class="col-lg-6">
            ...
            <input type="number" min="0" class="form-control lease-select" placeholder="Diện tích (m2)" name="dientich"
                   id="dientich">
            <div id="ktdt" class="sub"></div>
        </div>
        <div class="col-lg-6">
            <label class="col-lg-4">Giá tiền</label>
            <input type="number" min="0" class="lease-select form-control" placeholder="Giá tiền (triệu/tháng)"
                   name="gia" id="gia">
            <div id="ktgia" class="sub"></div>
        </div>
        <div class="col-lg-12">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12">
                    <label class="col-lg-2 lease-label margin-lable">Tên liên hệ</label>
                    <input type="text" class="lease-input form-control" placeholder="Liên hệ" name="lienhe"
                           id="tenlienhe">
                    <div class="class=" col-lg-2
                    ">
                </div>
        ...
        <div class="col-lg-12">
            <label class="col-lg-2 lease-label margin-lable">Điện thoại</label>
            <input type="text" class="lease-input form-control" placeholder="Điện thoại di động" name="dtdd"
                   id="dienthoai">
            <div class="class=" col-lg-2
            ">
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4"><label id="dongia">Đơn giá</label></div>
                <div class="col-lg-4"><label id="songaydang">Số ngày đăng</label></div>
                <div class="col-lg-4"><label id="tongtien">Tổng tiền</label></div>
            </div>
            <div class="row">
                <div class="col-lg-5"></div>
                <button class="btn south-btn" name="Submit" onClick="DangTin()"
                        style="width: 20%;font-size: 15px;margin-top:50px">ĐĂNG TIN
                </button>
            </div>
        </div>
        </div>
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        var changeday1 = false, changeday2 = false;
        tienthaydoi = false;
            ...
            $('#tp').on('change', function () {
                if (tp) {
                    $.ajax({
                        ...
                        async: true,
                        success: function (html) {
                            $('#select-quan').html(html);
                        }
                    });
                } else {
                    $('#select-quan').html('<option value="0">Chọn thành phố</option>');
                }
            });
            ...
            $('#select-quan').on('change', function () {
                ...
                if (quan) {
                    $.ajax({
                        ...
                        async: true,
                        success: function (html) {
                            $('#select-phuong').html(html);
                        }
                    });
                } else {
                    $('#select-phuong').html('<option value="0">Chọn quận/huyện</option>');
                }
            });
