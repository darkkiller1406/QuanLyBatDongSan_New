            ...
            <div class="row">
                ...
                <!-- Single Listings Slides -->
                    <div class="single-listings-sliders owl-carousel">
                        ...
                        <img src="<?php echo asset('img/ThuePhong/' . $array[$a]) ?>" class="img-responsive"
                             alt="properties"/>
                        <?php }?>
                    </div>
                </div>
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-8">
                    <div class="listings-content">
                        ...
                        <p class="location"><img src="<?php echo asset('img/icons/location.png') ?>"
                                                 style="margin-top: -8px" alt=""><?php $tam = ''; ?>
                            {{$chitiet->DiaChi}}, {{$chitiet->phuong->TenPhuong}}
                            , {{$chitiet->TenQuan($chitiet->Phuong)}}, {{$chitiet->TenThanhPho($chitiet->Phuong)}}
                        </p>
                        <!-- Listings Btn Groups -->
                        ...
                        <div class="realtor-info">
                            <div class="realtor---info">
                                ...
                                <p><b>Người đăng:</b> {{$chitiet->nguoidang->Ten}}<br>
                                    ...
                                    <b>Ngày
                                        đăng:</b> <?php $date1 = date_create($chitiet->NgayBatDau); ?> {{$date1->format('d/m/Y H:i:s')}}
                                    <br>
                                    <b>Ngày hết
                                        hạn:</b> <?php $date2 = date_create($chitiet->NgayKetThuc); ?> {{$date2->format('d/m/Y H:i:s')}}
                                    <br>
                                    <b>Diện tích:</b> {{$chitiet->DienTich}} m2<br>
                                </p>
                                <h6><img src="<?php echo asset('img/icons/phone-call.png') ?>"
                                         alt=""> {{$chitiet->DienThoaiLienLac}}</h6>
                                <h6><img src="<?php echo asset('img/icons/envelope.png') ?>" alt=""> {{$chitiet->Email}}
                                </h6>
                            </div>
                        </div>
                    </div>
